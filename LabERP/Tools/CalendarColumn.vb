...
Public Class CalendarColumn
    ...
    Public Overrides Property CellTemplate() As DataGridViewCell
        ...
        Set(ByVal value As DataGridViewCell)
            ...
            If Not (value Is Nothing) And Not value.GetType().IsAssignableFrom(GetType(CalendarCell)) Then
...
#Region "CalendarEditingControl Class"
...
End Class 'CalendarEditingControl
#End Region
