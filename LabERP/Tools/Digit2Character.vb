...
Module Digit2Character

    Public Function HANY(ByVal HANY1 As Object, ByVal HANY2 As String) As String
        ...
        Select Case HANY2
            Case "Pricing"
                ...
                If WORDINTEGER <> "" And (VPS <= 2) Then HANY = WORDINTEGER & LE & " و " & WORDPS & P
                If WORDINTEGER <> "" And (VPS >= 3 And VPS <= 9) Then HANY = WORDINTEGER & LE & " و " & WORDPS & PS
                If WORDINTEGER <> "" And (VPS > 9) Then HANY = WORDINTEGER & LE & " و " & WORDPS & P
                If WORDINTEGER = "" And (VPS <= 2) Then HANY = WORDPS & P
                If WORDINTEGER = "" And (VPS >= 3 And VPS <= 9) Then HANY = WORDPS & PS
                If WORDINTEGER = "" And VPS > 9 Then HANY = WORDPS & P
                If WORDINTEGER = "" And VPS = 0 Then HANY = ""
                If WORDINTEGER <> "" And VPS = 0 Then HANY = WORDINTEGER & LE
            ...
            Case "EGYPT"
                ...
                WORDINTEGER = AmountWord(V)
                WORDPS = AmountWord(VPS)
                If WORDINTEGER <> "" And (VPS <= 2) Then HANY = "فقط " & WORDINTEGER & LE & " و " & WORDPS & P & "لاغير"
                If WORDINTEGER <> "" And (VPS >= 3 And VPS <= 9) Then HANY = "فقط " & WORDINTEGER & LE & " و " & WORDPS & PS & "لاغير"
                If WORDINTEGER <> "" And (VPS > 9) Then HANY = "فقط " & WORDINTEGER & LE & " و " & WORDPS & P & "لاغير"
                If WORDINTEGER = "" And (VPS <= 2) Then HANY = "فقط " & WORDPS & P & "لاغير"
                If WORDINTEGER = "" And (VPS >= 3 And VPS <= 9) Then HANY = "فقط " & WORDPS & PS & "لاغير"
                If WORDINTEGER = "" And VPS > 9 Then HANY = "فقط " & WORDPS & P & "لاغير"
                If WORDINTEGER = "" And VPS = 0 Then HANY = ""
                If WORDINTEGER <> "" And VPS = 0 Then HANY = "فقط " & WORDINTEGER & LE & "لاغير"
            Case "USA"
                DOLLAR = " دولار "
                SENT = " سنتاً "
                SENTS = "سنتات"
            ...
            Case "DATE"
                HANY = MydateWord(HANY1)
            Case "TIME"
                HANY = MytimeWord(HANY1)
        End Select
